...
path = os.getcwd()
clibrary = ctypes.CDLL(os.path.join(path, 'sa.so'))
...
sa_algorithm = clibrary.sa_algorithm
sa_algorithm.argtypes = [ctypes.POINTER(Node), ctypes.c_int, ctypes.c_int, ctypes.c_int]
sa_algorithm(nodes, v, N+1, 10000) 